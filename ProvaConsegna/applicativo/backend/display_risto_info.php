...
if (!isset($_SESSION["utente"])) {
    ...
    $sql = "SELECT ristorante.*, indirizzo.*, sedelegale.via AS viasl, sedelegale.numero AS numerosl, sedelegale.cap AS capsl, sedelegale.citta AS cittasl, operainrist.zona, rlavorasu.turno
